...
//		GUILayout.Label ("", EditorStyles.boldLabel);
		...
		if(myXmlAsset){
			...
			if(movementXml!=null)
			{
				...
				//read gps ref point
				if(movementXml.SelectSingleNode("movement")==null){
...
public class DrawAreas:MonoBehaviour {
	...
	public bool previewAreas,closeArea,isPath,isOnsite,isDead, editableAreas, hasPathFreeMove=true;
