...
namespace CnControls
{
...
#endif
    {
		...
		{
			if(Diadrasis.Instance.user==Diadrasis.User.inAsanser || (Diadrasis.Instance.user==Diadrasis.User.onAir && !Diadrasis.Instance.moveOnAir))
			{
				if(gameObject.name=="JoyMove" || gameObject.name=="joyMove")
				{
					Hide(true);
				}
			}
